        ...
        <div className={styles.homeContainer}>
            <div>
                <div className={styles.titleCont}>
                    ...
                    <Image className={styles.logo} src='https://upload.wikimedia.org/wikipedia/en/e/eb/Sunrisers_Hyderabad.png' alt='ipl logo' width={100} height={100}/>
                    </div>
                ...
                <p className={styles.about}>The 2024 season was the 12th season for the Indian Premier League franchise Sunrisers Hyderabad. 
                    ...
                    They finished at the last place in previous seasons League stage.
            ...
            <Image className={styles.teamImage} src='https://images.firstpost.com/uploads/2024/04/Sunrisers-Hyderabad1-2024-04-692bb5ed59c63db10c08c28f0935a2e3-1200x675.jpg?im=FitAndFill=(596,336)' alt="ipl image" height={350} width={550}/>
        </div>
    )
}
